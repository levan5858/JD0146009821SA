...
const translations = {
    ar: {
        ...
        zipSearchLabel: "ابحث بالدولة أو المدينة أو الرمز البريدي:",
        zipSearchPlaceholder: "مثال: الرياض، السعودية، 11564، أو New York, USA",
        zipSearchHint: "يمكنك البحث عن أي دولة أو مدينة أو رمز بريدي من أي مكان في العالم",
        zipSearchInfo: "ابحث عن الرموز البريدية من أي دولة في العالم. أدخل اسم المدينة أو الدولة أو الرمز البريدي للحصول على نتائج دقيقة.",
        zipSearchError: "حدث خطأ في البحث. يرجى المحاولة مرة أخرى.",
        ...
        labelOriginCountry: "الدولة الأصلية:",
        labelDestinationCountry: "الدولة الوجهة:",
        labelDestination: "المدينة الوجهة:",
        selectCountry: "اختر الدولة",
        labelCountry: "الدولة:",
        zipCountryLabel: "الدولة:",
        popularCountriesTitle: "الدول الشائعة",
    ...
    en: {
        ...
        zipSearchLabel: "Search by Country, City, Area, or Postal Code:",
        zipSearchPlaceholder: "Example: Riyadh, Saudi Arabia, 11564, or New York, USA",
        zipSearchHint: "You can search by any country, city name, or postal code from anywhere in the world",
        zipSearchInfo: "Search for postal codes from any country worldwide. Enter a city name, country name, or postal code to find accurate results.",
        zipSearchError: "Error searching. Please try again.",
        ...
        labelOriginCountry: "Origin Country:",
        labelDestinationCountry: "Destination Country:",
        labelDestination: "Destination City:",
        selectCountry: "Select Country",
        labelCountry: "Country:",
        zipCountryLabel: "Country:",
        popularCountriesTitle: "Popular Countries",
